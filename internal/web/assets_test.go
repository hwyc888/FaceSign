...
func TestAutoStartCheckinSettingUIAndFlow(t *testing.T) {
	...
	for _, want := range []string{
		...
		`id="realtimeStatusMode"`,
		`id="realtimeStatusVideo"`,
		`id="realtimeStatusDrop"`,
		`id="realtimeStatusNetwork"`,
		`id="realtimeStatusRecognition"`,
		`id="realtimeStatusReason"`,
	...
	for _, want := range []string{
		...
		"realtime_status_mode",
		"realtime_status_video",
		"realtime_status_drop",
		"realtime_status_network",
		"realtime_status_recognition",
		"realtime_status_reason",
...
func TestCameraFullscreenAndRealtimeStatusSwitch(t *testing.T) {
	...
	for _, want := range []string{
		...
		"cameraRealtimeStatusFields[name] === false",
